...
<nav style="margin-left: 200px;">
    ...
    <div class="tabs">
        ...
        <div class="tab" id="tab-search-name">Crée par Nom et Prénom</div>
    </div>

    <div class="form-container" id="form-create-ppr">
        <h5>Cessation&Reprise:</h5>
        <form action="cessationRepriseAction.php" method="post">
            <div>
    ...
    <div class="form-container" id="form-search-name" style="display: none;">
        <h5>Cessation&Reprise:</h5>
        <form action="cessationNamePreAction.php" method="post">
            <div>
